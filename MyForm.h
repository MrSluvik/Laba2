...
#pragma region Windows Form Designer generated code
				...
				void InitializeComponent(void)
				{
					...
					this->label1->Font = (gcnew System::Drawing::Font(L"Times New Roman", 13.8F, System::Drawing::FontStyle::Bold));
					...
					this->label2->Size = System::Drawing::Size(219, 25);
					...
					// textBox1
					// 
					this->textBox1->Location = System::Drawing::Point(237, 13);
					...
					// textBox2
					// 
					this->textBox2->Location = System::Drawing::Point(237, 47);
					...
					// textBox3
					// 
					this->textBox3->Location = System::Drawing::Point(238, 92);
					...
					// textBox4
					// 
					this->textBox4->Location = System::Drawing::Point(12, 213);
					...
					this->label4->Size = System::Drawing::Size(349, 25);
					...
					this->button1->Location = System::Drawing::Point(307, 352);
...
#pragma endregion
			private: System::Void button1_MouseClick(System::Object^ sender, System::Windows::Forms::MouseEventArgs^ e) {
				textBox4->Text = "";// чистим вікно перед кожним новим виводом 
				//конвертую текст в число
				double x = Convert::ToDouble(textBox1->Text); 
				double y = Convert::ToDouble(textBox2->Text);
				double z = Convert::ToDouble(textBox3->Text);
				//вивожу у вікно інформацію про данні введені користувачем 
				textBox4->Text += " Лаб. роб. №1. ст.гр. РТ-23б Харжевський О.О";
				textBox4->Text += "\r\n\n X = " + Convert::ToString(x);
				textBox4->Text += "\r\n\n\n"" Y = " + Convert::ToString(y);
				textBox4->Text += "\r\n\n\n\n"" Z = " + Convert::ToString(z);
			
				
				const double pi = 0.523;
